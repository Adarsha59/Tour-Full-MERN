        ...
        <div className="container">
          ...
          <div className="w-full border-t border-slate-700 pt-10">
            ...
            <p className="text-center text-xs font-medium text-slate-500">
              ...
              . <br />
              <br />
              Semua logo, merek dagang, dan hak cipta yang terkandung di situs
              web ini adalah dan tetap menjadi milik dari pemiliknya
              masing-masing. Penggunaan materi-materi ini tidak menyiratkan
              pengesahan oleh perusahaan-perusahaan ini. Tidak ada lisensi atau
              hak lain dalam atau atas logo dan/atau merek dagang tersebut yang
              diberikan.
            </p>
          </div>
        </div>
