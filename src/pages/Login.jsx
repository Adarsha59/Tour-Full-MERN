    ...
    <>
      <section className="pt-36 pb-32  dark:bg-slate-200 text-white">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <a
            href="#"
            className="flex items-center mb-6 dark:text-black text-2xl font-semibold "
          >
            Adarsha-Tour
          </a>
          <div className="w-full  rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
