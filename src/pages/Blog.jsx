                ...
                <div className="py-8 px-6">
                  <h3>
                    <a
                      ...
                      className="mb-3 block truncate text-xl font-semibold dark:text-black hover:text-primary cursor-pointer"
                    >
                      {blog.title}
                    </a>
                  </h3>
                  ...
                  <a
                    onClick={() => handleNavigate(blog)}
                    className="rounded-full bg-primary py-3 px-4 text-sm font-medium text-white hover:opacity-80 cursor-pointer"
                  >
                    Read More
                  </a>
                </div>
